...
const Hero = () => {
  return (
    ...
    <div className="container flex flex-col md:flex-row items-center px-6 mx-auto py-10 space-y-0 md:space-y-0">
      ...
      <div>
        <Image src={shimPlaceholderPic} alt="Shimiiy Placeholder" width={500} height={500}/>
        <p className="text-white text-center">Editor&apos;s Note:（そのうち、上のこの画像の代わりに3Dモデルを置きたいね。）</p>
      </div>
    </div>
  )
}
