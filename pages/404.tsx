  ...
  return (
    <div>
      ...
      <main className="container flex items-center px-6 mx-auto">
        ...
        <div className="flex mx-auto h-full flex-col md:flex-row p-6 w-full items-center">
          <div className="p-6">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="my-6">
              ...
              <p><span className="font-medium text-red-500">They&apos;re not ready just yet!</span> Sorry for the inconvinience!</p>
